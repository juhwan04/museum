...
![본인확인](screenshot/myCheck2.png)
![본인확인](screenshot/myCheck3.png)
![본인확인](screenshot/myCheck4.png)
...
### 변경 
<img src="./screenshot/개인정보변경2.png" width="100%" height="100%" alt="개인정보변경"></img>
...
### DB Update
![ID변경](screenshot/ID변경.png)
![ID변경](screenshot/DBID.png)

## 비밀번호 변경
![pw변경](screenshot/pw변경.png)

### DB Update
![pw변경](screenshot/DBpw.png)

## 회원탈퇴
![탈퇴](screenshot/탈퇴.png)
### Check 확인
...
### my글 목록
![내글](screenshot/나의글.png)

### 댓글
![댓글](screenshot/댓글.png)

### 글 삭제
![알림](screenshot/글삭제.png)
